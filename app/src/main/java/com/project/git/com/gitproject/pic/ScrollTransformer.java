 ...
 * @description
 */
public class ScrollTransformer implements GalleryManager.ItemTransformer {
    ...
    @Override
    public void transformItem(GalleryManager layoutManager, View item, float fraction) {
