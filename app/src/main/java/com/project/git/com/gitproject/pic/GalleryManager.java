...
/**
 * created by wangyu on 2020/4/26 3:46 PM
 * description:
 */
public class GalleryManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public GalleryManager(int orientation) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(GalleryManager layoutManager, View item, float fraction);
    }
