...
public class LinePagerIndicator extends View implements IPagerIndicator {
    ...
    private static final int mIndicatorHeight = 2;
    ...
    protected void onDraw(Canvas canvas) {
        LinearGradient lg = new LinearGradient(getLineRect().left, getLineRect().top, getLineRect().right, getLineRect().bottom,
                new int[]{0xff0492fb, 0x990492fb}, null, LinearGradient.TileMode.CLAMP);
    ...
    private void init(Context context) {
        ...
        mLineHeight = DeviceUtil.dip2px(context, mIndicatorHeight);
        mLineWidth = DeviceUtil.dip2px(context, mIndicatorWidth);
    }
